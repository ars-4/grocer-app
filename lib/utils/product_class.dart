class Product {
  ...
  final String? ribbonName;
  final String? ribbonBgColor;
  final String? ribbonTextColor;
  ...
  Product({
    ...
    required this.ribbonName,
    required this.ribbonBgColor,
    required this.ribbonTextColor,
  });
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    return Product(
      ...
      ribbonName: json['ribbon_name'] as String? ?? '',
      ribbonBgColor: json['ribbon_bg_color'] as String? ?? '',
      ribbonTextColor: json['ribbon_text_color'] as String? ?? ''
    );
  }
}
