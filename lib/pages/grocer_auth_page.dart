...
import 'package:grocer/pages/otp_screen_page.dart';
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (response.statusCode == 200 || response.statusCode == 201) {
          ...
          _showSnackBar('Looks like this account already existed or perhaps try stronger password ${response.body}', "error");
        }
      } catch (e) {
        _showSnackBar("An Unexpexted error Occured ${e.toString()}", "error");
      }
